...
TARIFFS: dict[str, dict[str, tuple[str, str] | None]] = {
    ...
    "Подсветка": {
        ...
        # Комбинированная — контурная плюс фронтальная, но у значения
        # справочника единица одна, и суммой двух разных она не бывает.
        # Здесь она стоит как контурная; настоящее решение — за
        # владельцем и отдельным разговором (см. README рядом)
        "Комбинированная": (LINEAR, "3800"),
        "Фронтальная": (SQUARE, "4000"),
        "Без подсветки": None,
    },
