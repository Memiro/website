...
числовые атрибуты показываются в характеристиках, но фильтров не дают.
Счётчики значений фасетные: количество считается при всех остальных
выбранных фильтрах, кроме фильтров своего атрибута.
"""
...
# Токены значений атрибута «да/нет» в querystring и их подписи
...
class CatalogFilters:
    ...
    def groups(self, base: QuerySet[Product]) -> list[FilterGroup]:
        """Группы для сайдбара с фасетными счётчиками.
