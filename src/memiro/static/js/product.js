...
(() => {
  ...
  // больше нет (тикет 07), и ведём к свободной: адрес приезжает из
  // шаблона, чтобы маршруты Django не переписывались в браузере
  const invite = (text) => {
    const link = document.createElement("a");
    link.className = "link-underline";
    link.href = root.dataset.calcInquiry;
