...
(() => {
  ...
  const NOTES = {
    ...
    inquiry:
      ...
      "в корзину и опишите размер в заявке — менеджер назовёт цену.",
    failed:
      "Не удалось посчитать цену. Попробуйте ещё раз или добавьте " +
      "зеркало в корзину и напишите размер в заявке.",
  };
  ...
  // размера у товара нет, и до них считать нечего. Приложить это
  // к позиции заявки — работа тикета 14 (ADR-0009); сегодня набранное
  // никуда, кроме расчёта, не уезжает
  const configuration = () => {
