...
class SelectedValue:
    ...
    # два выреза стоят вдвое (тикет 22, «Вырез: количество»). Число, а
    # не целое: количество приходит из админки полем с дробной частью,
    # и обрезать его до целого значило бы молча посчитать «2,5» как «2»
