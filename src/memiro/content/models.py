...
# Заглушка вместо ссылки на MAX: иконку владелец велел поставить до
# того, как пришлёт адрес, чтобы про неё не забыли (тикет 08). Корень
# `max.ru`, а не выдуманное имя профиля: придуманный адрес привёл бы
# на чужую страницу, а корень просто никуда не ведёт. Разметка эту
# строку узнаёт и профилем студии не называет
...
class SiteContacts(SingletonModel):
    ...
    max_link = models.URLField(
        ...
        f"«{MAX_PLACEHOLDER}» поисковику не уходит: витрина иконку "
