...
Транспорт уведомления менеджеру тут ни при чём — это тикет 19 (он же
позже увёл уведомление на почту). Иконка на витрине и труба, по которой
едет заявка, — разные вещи.
"""
