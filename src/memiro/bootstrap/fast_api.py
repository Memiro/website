...
from memiro.presentation.fast_api.routers.catalog import router as catalog_router
...
from memiro.presentation.fast_api.routers.works import router as works_router
